<template>
  ...
  <div class="flex flex-col h-screen">
    ...
    <div class="w-full h-full pt-4 pb-4 pl-4 rounded-lg flex flex-row gap-5">
      <div class="pt-12">
        <div class="w-24 h-full box-border rounded-lg flex flex-col place-items-center gap-5 p-5 bg-secondary-light">
          <h1 class="italic text-5xl text-transparent bg-clip-text bg-gradient-to-r from-primary to-primary-light cursor-pointer">L</h1>
          <label class="rounded-xl p-4 cursor-pointer bg-gray-200 h-16 w-16 has-[:checked]:bg-gradient-to-r from-primary to-primary-light after:content-['']">
          ...
          <label class="rounded-xl p-4 bg-gray-200 cursor-pointer h-16 w-16 has-[:checked]:bg-gradient-to-r from-primary to-primary-light after:content-['']">
      ...
      <div class="overflow-y-auto w-full h-full box-border rounded-lg flex flex-col place-items-center gap-5 pr-4 pt-12">
